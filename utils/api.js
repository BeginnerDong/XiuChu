...
class Api extends Base {
	...
	couponUpdate(param, callback) {
		var allParams = {
			url: 'Common/Coupon/update',
			type: 'post',
			noToken: true,
			data: param,
			sCallback: function(data) {
	...
	couponDelete(param, callback) {
		var allParams = {
			url: 'Common/Coupon/delete',
			type: 'post',
			noToken: true,
			data: param,
			sCallback: function(data) {
	...
	sizeAdd(param, callback) {
		var allParams = {
			url: 'Common/UserSize/add',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	sizeGet(param, callback) {
		var allParams = {
			url: 'Common/UserSize/get',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	sizeUpdate(param, callback) {
		var allParams = {
			url: 'Common/UserSize/update',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
	...
	sizeDelete(param, callback) {
		var allParams = {
			url: 'Common/UserSize/delete',
			type: 'post',
			data: param,
			sCallback: function(data) {
				callback && callback(data);
